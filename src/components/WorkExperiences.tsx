...
const workExperienceData = [
  ...
  },
  {
    ...
    description: `As the NBA Program Coordinator, successfully led the ECE department to NBA accreditation (2023-2026). As Dean of Research and an APJAKTU Research Guide, have one registered scholar and have published in an international Scopus-indexed conference. Secured ₹2,00,000 in seed funding from Kerala Startup Mission's IDEA Fest 2022 and showcased an AI-based offense detection demo at the Ente Keralam program by the Government of Kerala.`,
